...
using AMDGPU.rocBLAS: band, bandex
    ...
    @testset for elty in [Float32, Float64, ComplexF32, ComplexF64]
        ...
        @testset "banded methods" begin
            ...
            @testset "gbmv!" begin
                ...
                y = rand(elty,m)
                d_y = ROCArray(y)
                rocBLAS.gbmv!('N',m,kl,ku,alpha,d_Ab,d_x,beta,d_y)
                ...
                y = rand(elty,m)
                d_y = ROCArray(y)
                rocBLAS.gbmv!('T',m,kl,ku,alpha,d_Ab,d_y,beta,d_x)
                ...
                y = rand(elty,m)
                d_y = ROCArray(y)
                rocBLAS.gbmv!('C',m,kl,ku,alpha,d_Ab,d_y,beta,d_x)
