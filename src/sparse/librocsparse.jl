...
function rocsparse_spmv_ex(handle, trans, alpha, mat, x, beta, y, compute_type, alg, stage,
                           buffer_size, temp_buffer)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_spmv_ex(handle::rocsparse_handle,
                                                 trans::rocsparse_operation,
                                                 alpha::Ptr{Cvoid},
                                                 mat::rocsparse_spmat_descr,
...
function rocsparse_sbsrmv_ex_analysis(handle, dir, trans, mb, nb, nnzb, descr, bsr_val,
    ...
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_sbsrmv_ex_analysis(handle::rocsparse_handle,
                                                            dir::rocsparse_direction,
                                                            trans::rocsparse_operation,
                                                            mb::rocsparse_int,
                                                            nb::rocsparse_int,
...
function rocsparse_dbsrmv_ex_analysis(handle, dir, trans, mb, nb, nnzb, descr, bsr_val,
                                      bsr_row_ptr, bsr_col_ind, block_dim, info)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_dbsrmv_ex_analysis(handle::rocsparse_handle,
                                                            dir::rocsparse_direction,
                                                            trans::rocsparse_operation,
                                                            mb::rocsparse_int,
                                                            nb::rocsparse_int,
...
function rocsparse_cbsrmv_ex_analysis(handle, dir, trans, mb, nb, nnzb, descr, bsr_val,
                                      bsr_row_ptr, bsr_col_ind, block_dim, info)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_cbsrmv_ex_analysis(handle::rocsparse_handle,
                                                            dir::rocsparse_direction,
                                                            trans::rocsparse_operation,
                                                            mb::rocsparse_int,
                                                            nb::rocsparse_int,
...
function rocsparse_zbsrmv_ex_analysis(handle, dir, trans, mb, nb, nnzb, descr, bsr_val,
                                      bsr_row_ptr, bsr_col_ind, block_dim, info)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_zbsrmv_ex_analysis(handle::rocsparse_handle,
                                                            dir::rocsparse_direction,
                                                            trans::rocsparse_operation,
                                                            mb::rocsparse_int,
                                                            nb::rocsparse_int,
...
function rocsparse_sbsrmv_ex(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val,
    ...
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_sbsrmv_ex(handle::rocsparse_handle,
                                                   dir::rocsparse_direction,
                                                   trans::rocsparse_operation,
                                                   mb::rocsparse_int,
...
function rocsparse_dbsrmv_ex(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val,
                             bsr_row_ptr, bsr_col_ind, block_dim, info, x, beta, y)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_dbsrmv_ex(handle::rocsparse_handle,
                                                   dir::rocsparse_direction,
                                                   trans::rocsparse_operation,
                                                   mb::rocsparse_int,
                                                   nb::rocsparse_int, nnzb::rocsparse_int,
...
function rocsparse_cbsrmv_ex(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val,
                             bsr_row_ptr, bsr_col_ind, block_dim, info, x, beta, y)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_cbsrmv_ex(handle::rocsparse_handle,
                                                   dir::rocsparse_direction,
                                                   trans::rocsparse_operation,
                                                   mb::rocsparse_int,
                                                   nb::rocsparse_int, nnzb::rocsparse_int,
...
function rocsparse_zbsrmv_ex(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val,
                             bsr_row_ptr, bsr_col_ind, block_dim, info, x, beta, y)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_zbsrmv_ex(handle::rocsparse_handle,
                                                   dir::rocsparse_direction,
                                                   trans::rocsparse_operation,
                                                   mb::rocsparse_int,
                                                   nb::rocsparse_int, nnzb::rocsparse_int,
...
function rocsparse_bsrmv_ex_clear(handle, info)
    AMDGPU.prepare_state()
    @check @ccall librocsparse.rocsparse_bsrmv_ex_clear(handle::rocsparse_handle,
                                                        info::rocsparse_mat_info)::rocsparse_status
end
