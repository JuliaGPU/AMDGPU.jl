...
function rocsparse_create_handle(handle)
    ccall((:rocsparse_create_handle, librocsparse), rocsparse_status, (Ptr{rocsparse_handle},), handle)
end

function rocsparse_destroy_handle(handle)
    ccall((:rocsparse_destroy_handle, librocsparse), rocsparse_status, (rocsparse_handle,), handle)
end

function rocsparse_set_stream(handle, stream)
    ccall((:rocsparse_set_stream, librocsparse), rocsparse_status, (rocsparse_handle, hipStream_t), handle, stream)
end

function rocsparse_get_stream(handle, stream)
    ccall((:rocsparse_get_stream, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{hipStream_t}), handle, stream)
end

function rocsparse_set_pointer_mode(handle, pointer_mode)
    ccall((:rocsparse_set_pointer_mode, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_pointer_mode), handle, pointer_mode)
end

function rocsparse_get_pointer_mode(handle, pointer_mode)
    ccall((:rocsparse_get_pointer_mode, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{rocsparse_pointer_mode}), handle, pointer_mode)
end

function rocsparse_get_version(handle, version)
    ccall((:rocsparse_get_version, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{Cint}), handle, version)
end

function rocsparse_get_git_rev(handle, rev)
    ccall((:rocsparse_get_git_rev, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{Cchar}), handle, rev)
end

function rocsparse_create_mat_descr(descr)
    ccall((:rocsparse_create_mat_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_mat_descr},), descr)
end

function rocsparse_copy_mat_descr(dest, src)
    ccall((:rocsparse_copy_mat_descr, librocsparse), rocsparse_status, (rocsparse_mat_descr, rocsparse_mat_descr), dest, src)
end

function rocsparse_destroy_mat_descr(descr)
    ccall((:rocsparse_destroy_mat_descr, librocsparse), rocsparse_status, (rocsparse_mat_descr,), descr)
end

function rocsparse_set_mat_index_base(descr, base)
    ccall((:rocsparse_set_mat_index_base, librocsparse), rocsparse_status, (rocsparse_mat_descr, rocsparse_index_base), descr, base)
end

function rocsparse_get_mat_index_base(descr)
    ccall((:rocsparse_get_mat_index_base, librocsparse), rocsparse_index_base, (rocsparse_mat_descr,), descr)
end

function rocsparse_set_mat_type(descr, type)
    ccall((:rocsparse_set_mat_type, librocsparse), rocsparse_status, (rocsparse_mat_descr, rocsparse_matrix_type), descr, type)
end

function rocsparse_get_mat_type(descr)
    ccall((:rocsparse_get_mat_type, librocsparse), rocsparse_matrix_type, (rocsparse_mat_descr,), descr)
end

function rocsparse_set_mat_fill_mode(descr, fill_mode)
    ccall((:rocsparse_set_mat_fill_mode, librocsparse), rocsparse_status, (rocsparse_mat_descr, rocsparse_fill_mode), descr, fill_mode)
end

function rocsparse_get_mat_fill_mode(descr)
    ccall((:rocsparse_get_mat_fill_mode, librocsparse), rocsparse_fill_mode, (rocsparse_mat_descr,), descr)
end

function rocsparse_set_mat_diag_type(descr, diag_type)
    ccall((:rocsparse_set_mat_diag_type, librocsparse), rocsparse_status, (rocsparse_mat_descr, rocsparse_diag_type), descr, diag_type)
end

function rocsparse_get_mat_diag_type(descr)
    ccall((:rocsparse_get_mat_diag_type, librocsparse), rocsparse_diag_type, (rocsparse_mat_descr,), descr)
end

function rocsparse_create_hyb_mat(hyb)
    ccall((:rocsparse_create_hyb_mat, librocsparse), rocsparse_status, (Ptr{rocsparse_hyb_mat},), hyb)
end

function rocsparse_destroy_hyb_mat(hyb)
    ccall((:rocsparse_destroy_hyb_mat, librocsparse), rocsparse_status, (rocsparse_hyb_mat,), hyb)
end

function rocsparse_create_mat_info(info)
    ccall((:rocsparse_create_mat_info, librocsparse), rocsparse_status, (Ptr{rocsparse_mat_info},), info)
end

function rocsparse_destroy_mat_info(info)
    ccall((:rocsparse_destroy_mat_info, librocsparse), rocsparse_status, (rocsparse_mat_info,), info)
end

function rocsparse_create_spvec_descr(descr, size, nnz, indices, values, idx_type, idx_base, data_type)
    ccall((:rocsparse_create_spvec_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spvec_descr}, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, size, nnz, indices, values, idx_type, idx_base, data_type)
end

function rocsparse_destroy_spvec_descr(descr)
    ccall((:rocsparse_destroy_spvec_descr, librocsparse), rocsparse_status, (rocsparse_spvec_descr,), descr)
end

function rocsparse_spvec_get(descr, size, nnz, indices, values, idx_type, idx_base, data_type)
    ccall((:rocsparse_spvec_get, librocsparse), rocsparse_status, (rocsparse_spvec_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_indextype}, Ptr{rocsparse_index_base}, Ptr{rocsparse_datatype}), descr, size, nnz, indices, values, idx_type, idx_base, data_type)
end

function rocsparse_spvec_get_index_base(descr, idx_base)
    ccall((:rocsparse_spvec_get_index_base, librocsparse), rocsparse_status, (rocsparse_spvec_descr, Ptr{rocsparse_index_base}), descr, idx_base)
end

function rocsparse_spvec_get_values(descr, values)
    ccall((:rocsparse_spvec_get_values, librocsparse), rocsparse_status, (rocsparse_spvec_descr, Ptr{Ptr{Cvoid}}), descr, values)
end

function rocsparse_spvec_set_values(descr, values)
    ccall((:rocsparse_spvec_set_values, librocsparse), rocsparse_status, (rocsparse_spvec_descr, Ptr{Cvoid}), descr, values)
end

function rocsparse_create_coo_descr(descr, rows, cols, nnz, coo_row_ind, coo_col_ind, coo_val, idx_type, idx_base, data_type)
    ccall((:rocsparse_create_coo_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spmat_descr}, Int64, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, rows, cols, nnz, coo_row_ind, coo_col_ind, coo_val, idx_type, idx_base, data_type)
end

function rocsparse_create_coo_aos_descr(descr, rows, cols, nnz, coo_ind, coo_val, idx_type, idx_base, data_type)
    ccall((:rocsparse_create_coo_aos_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spmat_descr}, Int64, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, rows, cols, nnz, coo_ind, coo_val, idx_type, idx_base, data_type)
end
...
function rocsparse_create_csr_descr(descr, rows, cols, nnz, csr_row_ptr, csr_col_ind, csr_val, row_ptr_type, col_ind_type, idx_base, data_type)
    ccall((:rocsparse_create_csr_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spmat_descr}, Int64, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_indextype, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, rows, cols, nnz, csr_row_ptr, csr_col_ind, csr_val, row_ptr_type, col_ind_type, idx_base, data_type)
end
...
function rocsparse_create_csc_descr(descr, rows, cols, nnz, csc_col_ptr, csc_row_ind, csc_val, col_ptr_type, row_ind_type, idx_base, data_type)
    ccall((:rocsparse_create_csc_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spmat_descr}, Int64, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_indextype, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, rows, cols, nnz, csc_col_ptr, csc_row_ind, csc_val, col_ptr_type, row_ind_type, idx_base, data_type)
end

function rocsparse_create_ell_descr(descr, rows, cols, ell_col_ind, ell_val, ell_width, idx_type, idx_base, data_type)
    ccall((:rocsparse_create_ell_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_spmat_descr}, Int64, Int64, Ptr{Cvoid}, Ptr{Cvoid}, Int64, rocsparse_indextype, rocsparse_index_base, rocsparse_datatype), descr, rows, cols, ell_col_ind, ell_val, ell_width, idx_type, idx_base, data_type)
end

function rocsparse_destroy_spmat_descr(descr)
    ccall((:rocsparse_destroy_spmat_descr, librocsparse), rocsparse_status, (rocsparse_spmat_descr,), descr)
end

function rocsparse_coo_aos_get(descr, rows, cols, nnz, coo_ind, coo_val, idx_type, idx_base, data_type)
    ccall((:rocsparse_coo_aos_get, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_indextype}, Ptr{rocsparse_index_base}, Ptr{rocsparse_datatype}), descr, rows, cols, nnz, coo_ind, coo_val, idx_type, idx_base, data_type)
end

function rocsparse_coo_get(descr, rows, cols, nnz, coo_row_ind, coo_col_ind, coo_val, idx_type, idx_base, data_type)
    ccall((:rocsparse_coo_get, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_indextype}, Ptr{rocsparse_index_base}, Ptr{rocsparse_datatype}), descr, rows, cols, nnz, coo_row_ind, coo_col_ind, coo_val, idx_type, idx_base, data_type)
end
...
function rocsparse_csr_get(descr, rows, cols, nnz, csr_row_ptr, csr_col_ind, csr_val, row_ptr_type, col_ind_type, idx_base, data_type)
    ccall((:rocsparse_csr_get, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_indextype}, Ptr{rocsparse_indextype}, Ptr{rocsparse_index_base}, Ptr{rocsparse_datatype}), descr, rows, cols, nnz, csr_row_ptr, csr_col_ind, csr_val, row_ptr_type, col_ind_type, idx_base, data_type)
end

function rocsparse_ell_get(descr, rows, cols, ell_col_ind, ell_val, ell_width, idx_type, idx_base, data_type)
    ccall((:rocsparse_ell_get, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{Ptr{Cvoid}}, Ptr{Int64}, Ptr{rocsparse_indextype}, Ptr{rocsparse_index_base}, Ptr{rocsparse_datatype}), descr, rows, cols, ell_col_ind, ell_val, ell_width, idx_type, idx_base, data_type)
end

function rocsparse_coo_set_pointers(descr, coo_row_ind, coo_col_ind, coo_val)
    ccall((:rocsparse_coo_set_pointers, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), descr, coo_row_ind, coo_col_ind, coo_val)
end

function rocsparse_coo_aos_set_pointers(descr, coo_ind, coo_val)
    ccall((:rocsparse_coo_aos_set_pointers, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}, Ptr{Cvoid}), descr, coo_ind, coo_val)
end

function rocsparse_csr_set_pointers(descr, csr_row_ptr, csr_col_ind, csr_val)
    ccall((:rocsparse_csr_set_pointers, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), descr, csr_row_ptr, csr_col_ind, csr_val)
end

function rocsparse_csc_set_pointers(descr, csc_col_ptr, csc_row_ind, csc_val)
    ccall((:rocsparse_csc_set_pointers, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), descr, csc_col_ptr, csc_row_ind, csc_val)
end

function rocsparse_ell_set_pointers(descr, ell_col_ind, ell_val)
    ccall((:rocsparse_ell_set_pointers, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}, Ptr{Cvoid}), descr, ell_col_ind, ell_val)
end

function rocsparse_spmat_get_size(descr, rows, cols, nnz)
    ccall((:rocsparse_spmat_get_size, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}), descr, rows, cols, nnz)
end

function rocsparse_spmat_get_format(descr, format)
    ccall((:rocsparse_spmat_get_format, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{rocsparse_format}), descr, format)
end

function rocsparse_spmat_get_index_base(descr, idx_base)
    ccall((:rocsparse_spmat_get_index_base, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{rocsparse_index_base}), descr, idx_base)
end

function rocsparse_spmat_get_values(descr, values)
    ccall((:rocsparse_spmat_get_values, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Ptr{Cvoid}}), descr, values)
end

function rocsparse_spmat_set_values(descr, values)
    ccall((:rocsparse_spmat_set_values, librocsparse), rocsparse_status, (rocsparse_spmat_descr, Ptr{Cvoid}), descr, values)
end

function rocsparse_create_dnvec_descr(descr, size, values, data_type)
    ccall((:rocsparse_create_dnvec_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_dnvec_descr}, Int64, Ptr{Cvoid}, rocsparse_datatype), descr, size, values, data_type)
end

function rocsparse_destroy_dnvec_descr(descr)
    ccall((:rocsparse_destroy_dnvec_descr, librocsparse), rocsparse_status, (rocsparse_dnvec_descr,), descr)
end

function rocsparse_dnvec_get(descr, size, values, data_type)
    ccall((:rocsparse_dnvec_get, librocsparse), rocsparse_status, (rocsparse_dnvec_descr, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_datatype}), descr, size, values, data_type)
end

function rocsparse_dnvec_get_values(descr, values)
    ccall((:rocsparse_dnvec_get_values, librocsparse), rocsparse_status, (rocsparse_dnvec_descr, Ptr{Ptr{Cvoid}}), descr, values)
end

function rocsparse_dnvec_set_values(descr, values)
    ccall((:rocsparse_dnvec_set_values, librocsparse), rocsparse_status, (rocsparse_dnvec_descr, Ptr{Cvoid}), descr, values)
end

function rocsparse_create_dnmat_descr(descr, rows, cols, ld, values, data_type, order)
    ccall((:rocsparse_create_dnmat_descr, librocsparse), rocsparse_status, (Ptr{rocsparse_dnmat_descr}, Int64, Int64, Int64, Ptr{Cvoid}, rocsparse_datatype, rocsparse_order), descr, rows, cols, ld, values, data_type, order)
end

function rocsparse_destroy_dnmat_descr(descr)
    ccall((:rocsparse_destroy_dnmat_descr, librocsparse), rocsparse_status, (rocsparse_dnmat_descr,), descr)
end

function rocsparse_dnmat_get(descr, rows, cols, ld, values, data_type, order)
    ccall((:rocsparse_dnmat_get, librocsparse), rocsparse_status, (rocsparse_dnmat_descr, Ptr{Int64}, Ptr{Int64}, Ptr{Int64}, Ptr{Ptr{Cvoid}}, Ptr{rocsparse_datatype}, Ptr{rocsparse_order}), descr, rows, cols, ld, values, data_type, order)
end

function rocsparse_dnmat_get_values(descr, values)
    ccall((:rocsparse_dnmat_get_values, librocsparse), rocsparse_status, (rocsparse_dnmat_descr, Ptr{Ptr{Cvoid}}), descr, values)
end

function rocsparse_dnmat_set_values(descr, values)
    ccall((:rocsparse_dnmat_set_values, librocsparse), rocsparse_status, (rocsparse_dnmat_descr, Ptr{Cvoid}), descr, values)
end

function rocsparse_saxpyi(handle, nnz, alpha, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_saxpyi, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_index_base), handle, nnz, alpha, x_val, x_ind, y, idx_base)
end

function rocsparse_daxpyi(handle, nnz, alpha, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_daxpyi, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_index_base), handle, nnz, alpha, x_val, x_ind, y, idx_base)
end

function rocsparse_caxpyi(handle, nnz, alpha, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_caxpyi, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_index_base), handle, nnz, alpha, x_val, x_ind, y, idx_base)
end

function rocsparse_zaxpyi(handle, nnz, alpha, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_zaxpyi, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_index_base), handle, nnz, alpha, x_val, x_ind, y, idx_base)
end

function rocsparse_sdoti(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_sdoti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{Cfloat}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_ddoti(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_ddoti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_cdoti(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_cdoti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_zdoti(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_zdoti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_cdotci(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_cdotci, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_zdotci(handle, nnz, x_val, x_ind, y, result, idx_base)
    ccall((:rocsparse_zdotci, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, result, idx_base)
end

function rocsparse_sgthr(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_sgthr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_dgthr(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_dgthr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_cgthr(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_cgthr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_zgthr(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_zgthr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_sgthrz(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_sgthrz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_dgthrz(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_dgthrz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_cgthrz(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_cgthrz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_zgthrz(handle, nnz, y, x_val, x_ind, idx_base)
    ccall((:rocsparse_zgthrz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, rocsparse_index_base), handle, nnz, y, x_val, x_ind, idx_base)
end

function rocsparse_sroti(handle, nnz, x_val, x_ind, y, c, s, idx_base)
    ccall((:rocsparse_sroti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, c, s, idx_base)
end

function rocsparse_droti(handle, nnz, x_val, x_ind, y, c, s, idx_base)
    ccall((:rocsparse_droti, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, c, s, idx_base)
end

function rocsparse_ssctr(handle, nnz, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_ssctr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, idx_base)
end

function rocsparse_dsctr(handle, nnz, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_dsctr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, idx_base)
end

function rocsparse_csctr(handle, nnz, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_csctr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, idx_base)
end

function rocsparse_zsctr(handle, nnz, x_val, x_ind, y, idx_base)
    ccall((:rocsparse_zsctr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_index_base), handle, nnz, x_val, x_ind, y, idx_base)
end

function rocsparse_sbsrmv(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
    ccall((:rocsparse_sbsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}), handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
end

function rocsparse_dbsrmv(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
    ccall((:rocsparse_dbsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
end

function rocsparse_cbsrmv(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
    ccall((:rocsparse_cbsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}), handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
end

function rocsparse_zbsrmv(handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
    ccall((:rocsparse_zbsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}), handle, dir, trans, mb, nb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, x, beta, y)
end

function rocsparse_bsrsv_zero_pivot(handle, info, position)
    ccall((:rocsparse_bsrsv_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Ptr{rocsparse_int}), handle, info, position)
end

function rocsparse_sbsrsv_buffer_size(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
    ccall((:rocsparse_sbsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
end

function rocsparse_dbsrsv_buffer_size(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
    ccall((:rocsparse_dbsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
end

function rocsparse_cbsrsv_buffer_size(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
    ccall((:rocsparse_cbsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
end

function rocsparse_zbsrsv_buffer_size(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
    ccall((:rocsparse_zbsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, buffer_size)
end

function rocsparse_sbsrsv_analysis(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_sbsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_dbsrsv_analysis(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_dbsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_cbsrsv_analysis(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_cbsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_zbsrsv_analysis(handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zbsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_bsrsv_clear(handle, info)
    ccall((:rocsparse_bsrsv_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_sbsrsv_solve(handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_sbsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Cfloat}, Ptr{Cfloat}, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
end

function rocsparse_dbsrsv_solve(handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_dbsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
end

function rocsparse_cbsrsv_solve(handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_cbsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
end

function rocsparse_zbsrsv_solve(handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_zbsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, trans, mb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, bsr_dim, info, x, y, policy, temp_buffer)
end

function rocsparse_scoomv(handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
    ccall((:rocsparse_scoomv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}), handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
end

function rocsparse_dcoomv(handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
    ccall((:rocsparse_dcoomv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
end

function rocsparse_ccoomv(handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
    ccall((:rocsparse_ccoomv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}), handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
end

function rocsparse_zcoomv(handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
    ccall((:rocsparse_zcoomv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}), handle, trans, m, n, nnz, alpha, descr, coo_val, coo_row_ind, coo_col_ind, x, beta, y)
end

function rocsparse_scsrmv_analysis(handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
    ccall((:rocsparse_scsrmv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info), handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
end

function rocsparse_dcsrmv_analysis(handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
    ccall((:rocsparse_dcsrmv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info), handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
end

function rocsparse_ccsrmv_analysis(handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
    ccall((:rocsparse_ccsrmv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info), handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
end

function rocsparse_zcsrmv_analysis(handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
    ccall((:rocsparse_zcsrmv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info), handle, trans, m, n, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info)
end

function rocsparse_csrmv_clear(handle, info)
    ccall((:rocsparse_csrmv_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_scsrmv(handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
    ccall((:rocsparse_scsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}), handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
end

function rocsparse_dcsrmv(handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
    ccall((:rocsparse_dcsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
end

function rocsparse_ccsrmv(handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
    ccall((:rocsparse_ccsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}), handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
end

function rocsparse_zcsrmv(handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
    ccall((:rocsparse_zcsrmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}), handle, trans, m, n, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, beta, y)
end

function rocsparse_csrsv_zero_pivot(handle, descr, info, position)
    ccall((:rocsparse_csrsv_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_mat_info, Ptr{rocsparse_int}), handle, descr, info, position)
end

function rocsparse_scsrsv_buffer_size(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_scsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_dcsrsv_buffer_size(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_dcsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_ccsrsv_buffer_size(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_ccsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_zcsrsv_buffer_size(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_zcsrsv_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end
...
function rocsparse_ccsrsv_analysis(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_ccsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end
...
function rocsparse_zcsrsv_analysis(handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zcsrsv_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_csrsv_clear(handle, descr, info)
    ccall((:rocsparse_csrsv_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_mat_info), handle, descr, info)
end
...
function rocsparse_ccsrsv_solve(handle, trans, m, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_ccsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans, m, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, y, policy, temp_buffer)
end
...
function rocsparse_zcsrsv_solve(handle, trans, m, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, y, policy, temp_buffer)
    ccall((:rocsparse_zcsrsv_solve, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans, m, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, info, x, y, policy, temp_buffer)
end

function rocsparse_sellmv(handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
    ccall((:rocsparse_sellmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}), handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
end

function rocsparse_dellmv(handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
    ccall((:rocsparse_dellmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
end

function rocsparse_cellmv(handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
    ccall((:rocsparse_cellmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}), handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
end

function rocsparse_zellmv(handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
    ccall((:rocsparse_zellmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}), handle, trans, m, n, alpha, descr, ell_val, ell_col_ind, ell_width, x, beta, y)
end

function rocsparse_shybmv(handle, trans, alpha, descr, hyb, x, beta, y)
    ccall((:rocsparse_shybmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, Ptr{Cfloat}, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{Cfloat}, Ptr{Cfloat}, Ptr{Cfloat}), handle, trans, alpha, descr, hyb, x, beta, y)
end

function rocsparse_dhybmv(handle, trans, alpha, descr, hyb, x, beta, y)
    ccall((:rocsparse_dhybmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, Ptr{Cdouble}, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), handle, trans, alpha, descr, hyb, x, beta, y)
end

function rocsparse_chybmv(handle, trans, alpha, descr, hyb, x, beta, y)
    ccall((:rocsparse_chybmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}), handle, trans, alpha, descr, hyb, x, beta, y)
end

function rocsparse_zhybmv(handle, trans, alpha, descr, hyb, x, beta, y)
    ccall((:rocsparse_zhybmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}), handle, trans, alpha, descr, hyb, x, beta, y)
end
...
function rocsparse_dbsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_dbsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, B, ldb, beta, C, ldc)
end
...
function rocsparse_zbsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_zbsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, B, ldb, beta, C, ldc)
end
...
function rocsparse_sgebsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_sgebsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
end
...
function rocsparse_dgebsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_dgebsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
end
...
function rocsparse_cgebsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_cgebsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, B, ldb, beta, C, ldc)
end

function rocsparse_zgebsrmm(handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, colblock_dim, B, ldb, beta, C, ldc)
    ccall((:rocsparse_zgebsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, dir, trans_A, trans_B, mb, n, kb, nnzb, alpha, descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, colblock_dim, B, ldb, beta, C, ldc)
end

function rocsparse_scsrmm(handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
    ccall((:rocsparse_scsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_int, Ptr{Cfloat}, Ptr{Cfloat}, rocsparse_int), handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
end

function rocsparse_dcsrmm(handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
    ccall((:rocsparse_dcsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, Ptr{Cdouble}, rocsparse_int), handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
end

function rocsparse_ccsrmm(handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
    ccall((:rocsparse_ccsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_float_complex}, rocsparse_int), handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
end

function rocsparse_zcsrmm(handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
    ccall((:rocsparse_zcsrmm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, trans_A, trans_B, m, n, k, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, beta, C, ldc)
end

function rocsparse_csrsm_zero_pivot(handle, info, position)
    ccall((:rocsparse_csrsm_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Ptr{rocsparse_int}), handle, info, position)
end
...
function rocsparse_ccsrsm_analysis(handle, trans_A, trans_B, m, nrhs, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_ccsrsm_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans_A, trans_B, m, nrhs, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, info, analysis, solve, temp_buffer)
end
...
function rocsparse_zcsrsm_analysis(handle, trans_A, trans_B, m, nrhs, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zcsrsm_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, trans_A, trans_B, m, nrhs, nnz, alpha, descr, csr_val, csr_row_ptr, csr_col_ind, B, ldb, info, analysis, solve, temp_buffer)
end

function rocsparse_csrsm_clear(handle, info)
    ccall((:rocsparse_csrsm_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end
...
function rocsparse_sbsric0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_sbsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_cbsric0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_cbsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_dbsric0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_dbsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end
...
function rocsparse_cbsric0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_cbsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end
...
function rocsparse_zbsric0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zbsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_bsric0_clear(handle, info)
    ccall((:rocsparse_bsric0_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_sbsric0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_sbsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_dbsric0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_dbsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_cbsric0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_cbsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_zbsric0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_zbsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_bsrilu0_zero_pivot(handle, info, position)
    ccall((:rocsparse_bsrilu0_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Ptr{rocsparse_int}), handle, info, position)
end

function rocsparse_sbsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_sbsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cfloat}, Ptr{Cfloat}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_dbsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_dbsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cdouble}, Ptr{Cdouble}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_cbsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_cbsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cfloat}, Ptr{rocsparse_float_complex}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_zbsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_zbsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cdouble}, Ptr{rocsparse_double_complex}), handle, info, enable_boost, boost_tol, boost_val)
end
...
function rocsparse_sbsrilu0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_sbsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_dbsrilu0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_dbsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_cbsrilu0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_cbsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_zbsrilu0_buffer_size(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
    ccall((:rocsparse_zbsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, Ptr{Csize_t}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, buffer_size)
end
...
function rocsparse_sbsrilu0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_sbsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end
...
function rocsparse_dbsrilu0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_dbsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end
...
function rocsparse_cbsrilu0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_cbsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end
...
function rocsparse_zbsrilu0_analysis(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zbsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, analysis, solve, temp_buffer)
end

function rocsparse_bsrilu0_clear(handle, info)
    ccall((:rocsparse_bsrilu0_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_sbsrilu0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_sbsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_dbsrilu0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_dbsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_cbsrilu0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_cbsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_zbsrilu0(handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
    ccall((:rocsparse_zbsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, dir, mb, nnzb, descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, info, policy, temp_buffer)
end

function rocsparse_csric0_zero_pivot(handle, info, position)
    ccall((:rocsparse_csric0_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Ptr{rocsparse_int}), handle, info, position)
end

function rocsparse_scsric0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_scsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_dcsric0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_dcsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_ccsric0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_ccsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_zcsric0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_zcsric0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_scsric0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_scsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_dcsric0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_dcsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_ccsric0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_ccsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_zcsric0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zcsric0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_csric0_clear(handle, info)
    ccall((:rocsparse_csric0_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_scsric0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_scsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_dcsric0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_dcsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_ccsric0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_ccsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_zcsric0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_zcsric0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_csrilu0_zero_pivot(handle, info, position)
    ccall((:rocsparse_csrilu0_zero_pivot, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Ptr{rocsparse_int}), handle, info, position)
end

function rocsparse_scsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_scsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cfloat}, Ptr{Cfloat}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_dcsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_dcsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cdouble}, Ptr{Cdouble}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_ccsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_ccsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cfloat}, Ptr{rocsparse_float_complex}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_zcsrilu0_numeric_boost(handle, info, enable_boost, boost_tol, boost_val)
    ccall((:rocsparse_zcsrilu0_numeric_boost, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info, Cint, Ptr{Cdouble}, Ptr{rocsparse_double_complex}), handle, info, enable_boost, boost_tol, boost_val)
end

function rocsparse_scsrilu0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_scsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_dcsrilu0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_dcsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_ccsrilu0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_ccsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_zcsrilu0_buffer_size(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
    ccall((:rocsparse_zcsrilu0_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Csize_t}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, buffer_size)
end

function rocsparse_scsrilu0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_scsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_dcsrilu0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_dcsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_ccsrilu0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_ccsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_zcsrilu0_analysis(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
    ccall((:rocsparse_zcsrilu0_analysis, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_analysis_policy, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, analysis, solve, temp_buffer)
end

function rocsparse_csrilu0_clear(handle, info)
    ccall((:rocsparse_csrilu0_clear, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_info), handle, info)
end

function rocsparse_scsrilu0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_scsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_dcsrilu0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_dcsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_ccsrilu0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_ccsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_zcsrilu0(handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
    ccall((:rocsparse_zcsrilu0, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, rocsparse_solve_policy, Ptr{Cvoid}), handle, m, nnz, descr, csr_val, csr_row_ptr, csr_col_ind, info, policy, temp_buffer)
end

function rocsparse_snnz(handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
    ccall((:rocsparse_snnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
end

function rocsparse_dnnz(handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
    ccall((:rocsparse_dnnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
end

function rocsparse_cnnz(handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
    ccall((:rocsparse_cnnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
end

function rocsparse_znnz(handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
    ccall((:rocsparse_znnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, m, n, descr, A, ld, nnz_per_row_columns, nnz_total_dev_host_ptr)
end

function rocsparse_sdense2csr(handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_sdense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_ddense2csr(handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_ddense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_cdense2csr(handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_cdense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_zdense2csr(handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_zdense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_dprune_dense2csr_buffer_size(handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, buffer_size)
    ccall((:rocsparse_dprune_dense2csr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Csize_t}), handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, buffer_size)
end

function rocsparse_sprune_dense2csr_nnz(handle, m, n, A, lda, threshold, descr, csr_row_ptr, nnz_total_dev_host_ptr, temp_buffer)
    ccall((:rocsparse_sprune_dense2csr_nnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, A, lda, threshold, descr, csr_row_ptr, nnz_total_dev_host_ptr, temp_buffer)
end

function rocsparse_dprune_dense2csr_nnz(handle, m, n, A, lda, threshold, descr, csr_row_ptr, nnz_total_dev_host_ptr, temp_buffer)
    ccall((:rocsparse_dprune_dense2csr_nnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, A, lda, threshold, descr, csr_row_ptr, nnz_total_dev_host_ptr, temp_buffer)
end

function rocsparse_sprune_dense2csr(handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_sprune_dense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cfloat}, rocsparse_int, Ptr{Cfloat}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end

function rocsparse_dprune_dense2csr(handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_dprune_dense2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Ptr{Cdouble}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, A, lda, threshold, descr, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end
...
function rocsparse_dprune_dense2csr_by_percentage(handle, m, n, A, lda, percentage, descr, csr_val, csr_row_ptr, csr_col_ind, info, temp_buffer)
    ccall((:rocsparse_dprune_dense2csr_by_percentage, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, Ptr{Cdouble}, rocsparse_int, Cdouble, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Cvoid}), handle, m, n, A, lda, percentage, descr, csr_val, csr_row_ptr, csr_col_ind, info, temp_buffer)
end

function rocsparse_sdense2csc(handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
    ccall((:rocsparse_sdense2csc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
end

function rocsparse_ddense2csc(handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
    ccall((:rocsparse_ddense2csc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
end

function rocsparse_cdense2csc(handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
    ccall((:rocsparse_cdense2csc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
end

function rocsparse_zdense2csc(handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
    ccall((:rocsparse_zdense2csc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_columns, csc_val, csc_col_ptr, csc_row_ind)
end

function rocsparse_sdense2coo(handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
    ccall((:rocsparse_sdense2coo, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
end

function rocsparse_ddense2coo(handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
    ccall((:rocsparse_ddense2coo, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
end

function rocsparse_cdense2coo(handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
    ccall((:rocsparse_cdense2coo, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
end

function rocsparse_zdense2coo(handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
    ccall((:rocsparse_zdense2coo, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, descr, A, ld, nnz_per_rows, coo_val, coo_row_ind, coo_col_ind)
end

function rocsparse_scsr2dense(handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
    ccall((:rocsparse_scsr2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_int), handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
end

function rocsparse_dcsr2dense(handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
    ccall((:rocsparse_dcsr2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_int), handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
end

function rocsparse_ccsr2dense(handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
    ccall((:rocsparse_ccsr2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_int), handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
end

function rocsparse_zcsr2dense(handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
    ccall((:rocsparse_zcsr2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, m, n, descr, csr_val, csr_row_ptr, csr_col_ind, A, ld)
end

function rocsparse_scsc2dense(handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
    ccall((:rocsparse_scsc2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_int), handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
end

function rocsparse_dcsc2dense(handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
    ccall((:rocsparse_dcsc2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_int), handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
end

function rocsparse_ccsc2dense(handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
    ccall((:rocsparse_ccsc2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_int), handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
end

function rocsparse_zcsc2dense(handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
    ccall((:rocsparse_zcsc2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, m, n, descr, csc_val, csc_col_ptr, csc_row_ind, A, ld)
end

function rocsparse_scoo2dense(handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
    ccall((:rocsparse_scoo2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cfloat}, rocsparse_int), handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
end

function rocsparse_dcoo2dense(handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
    ccall((:rocsparse_dcoo2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cdouble}, rocsparse_int), handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
end

function rocsparse_ccoo2dense(handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
    ccall((:rocsparse_ccoo2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, rocsparse_int), handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
end

function rocsparse_zcoo2dense(handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
    ccall((:rocsparse_zcoo2dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_double_complex}, rocsparse_int), handle, m, n, nnz, descr, coo_val, coo_row_ind, coo_col_ind, A, ld)
end

function rocsparse_snnz_compress(handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
    ccall((:rocsparse_snnz_compress, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Cfloat), handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
end

function rocsparse_dnnz_compress(handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
    ccall((:rocsparse_dnnz_compress, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Cdouble), handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
end

function rocsparse_cnnz_compress(handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
    ccall((:rocsparse_cnnz_compress, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_float_complex), handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
end

function rocsparse_znnz_compress(handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
    ccall((:rocsparse_znnz_compress, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_double_complex), handle, m, descr_A, csr_val_A, csr_row_ptr_A, nnz_per_row, nnz_C, tol)
end

function rocsparse_csr2coo(handle, csr_row_ptr, nnz, m, coo_row_ind, idx_base)
    ccall((:rocsparse_csr2coo, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, rocsparse_index_base), handle, csr_row_ptr, nnz, m, coo_row_ind, idx_base)
end

function rocsparse_csr2csc_buffer_size(handle, m, n, nnz, csr_row_ptr, csr_col_ind, copy_values, buffer_size)
    ccall((:rocsparse_csr2csc_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_action, Ptr{Csize_t}), handle, m, n, nnz, csr_row_ptr, csr_col_ind, copy_values, buffer_size)
end
...
function rocsparse_ccsr2csc(handle, m, n, nnz, csr_val, csr_row_ptr, csr_col_ind, csc_val, csc_row_ind, csc_col_ptr, copy_values, idx_base, temp_buffer)
    ccall((:rocsparse_ccsr2csc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_action, rocsparse_index_base, Ptr{Cvoid}), handle, m, n, nnz, csr_val, csr_row_ptr, csr_col_ind, csc_val, csc_row_ind, csc_col_ptr, copy_values, idx_base, temp_buffer)
end
...
function rocsparse_cgebsr2gebsc_buffer_size(handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
    ccall((:rocsparse_cgebsr2gebsc_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
end
...
function rocsparse_zgebsr2gebsc_buffer_size(handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
    ccall((:rocsparse_zgebsr2gebsc_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
end
...
function rocsparse_cgebsr2gebsc(handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, bsc_val, bsc_row_ind, bsc_col_ptr, copy_values, idx_base, temp_buffer)
    ccall((:rocsparse_cgebsr2gebsc, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_action, rocsparse_index_base, Ptr{Cvoid}), handle, mb, nb, nnzb, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, bsc_val, bsc_row_ind, bsc_col_ptr, copy_values, idx_base, temp_buffer)
end
...
function rocsparse_dcsr2bsr(handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, block_dim, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind)
    ccall((:rocsparse_dcsr2bsr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, block_dim, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind)
end
...
function rocsparse_dcsr2gebsr_buffer_size(handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
    ccall((:rocsparse_dcsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
end
...
function rocsparse_ccsr2gebsr_buffer_size(handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
    ccall((:rocsparse_ccsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
end
...
function rocsparse_zcsr2gebsr_buffer_size(handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
    ccall((:rocsparse_zcsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, row_block_dim, col_block_dim, p_buffer_size)
end
...
function rocsparse_ccsr2gebsr(handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer)
    ccall((:rocsparse_ccsr2gebsr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Cvoid}), handle, dir, m, n, csr_descr, csr_val, csr_row_ptr, csr_col_ind, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, p_buffer)
end
...
function rocsparse_dcsr2csr_compress(handle, m, n, descr_A, csr_val_A, csr_row_ptr_A, csr_col_ind_A, nnz_A, nnz_per_row, csr_val_C, csr_row_ptr_C, csr_col_ind_C, tol)
    ccall((:rocsparse_dcsr2csr_compress, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, Ptr{rocsparse_int}, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Cdouble), handle, m, n, descr_A, csr_val_A, csr_row_ptr_A, csr_col_ind_A, nnz_A, nnz_per_row, csr_val_C, csr_row_ptr_C, csr_col_ind_C, tol)
end
...
function rocsparse_dprune_csr2csr_by_percentage(handle, m, n, nnz_A, csr_descr_A, csr_val_A, csr_row_ptr_A, csr_col_ind_A, percentage, csr_descr_C, csr_val_C, csr_row_ptr_C, csr_col_ind_C, info, temp_buffer)
    ccall((:rocsparse_dprune_csr2csr_by_percentage, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Cdouble, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_mat_info, Ptr{Cvoid}), handle, m, n, nnz_A, csr_descr_A, csr_val_A, csr_row_ptr_A, csr_col_ind_A, percentage, csr_descr_C, csr_val_C, csr_row_ptr_C, csr_col_ind_C, info, temp_buffer)
end

function rocsparse_coo2csr(handle, coo_row_ind, nnz, m, csr_row_ptr, idx_base)
    ccall((:rocsparse_coo2csr, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, rocsparse_index_base), handle, coo_row_ind, nnz, m, csr_row_ptr, idx_base)
end

function rocsparse_ell2csr_nnz(handle, m, n, ell_descr, ell_width, ell_col_ind, csr_descr, csr_row_ptr, csr_nnz)
    ccall((:rocsparse_ell2csr_nnz, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, rocsparse_int, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, ell_descr, ell_width, ell_col_ind, csr_descr, csr_row_ptr, csr_nnz)
end

function rocsparse_sell2csr(handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_sell2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, rocsparse_int, Ptr{Cfloat}, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_dell2csr(handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_dell2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, rocsparse_int, Ptr{Cdouble}, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_cell2csr(handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_cell2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, rocsparse_int, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_zell2csr(handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_zell2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_mat_descr, rocsparse_int, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, m, n, ell_descr, ell_width, ell_val, ell_col_ind, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end

function rocsparse_hyb2csr_buffer_size(handle, descr, hyb, csr_row_ptr, buffer_size)
    ccall((:rocsparse_hyb2csr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{rocsparse_int}, Ptr{Csize_t}), handle, descr, hyb, csr_row_ptr, buffer_size)
end

function rocsparse_shyb2csr(handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_shyb2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end

function rocsparse_dhyb2csr(handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_dhyb2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end

function rocsparse_chyb2csr(handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_chyb2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end

function rocsparse_zhyb2csr(handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
    ccall((:rocsparse_zhyb2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_mat_descr, rocsparse_hyb_mat, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, descr, hyb, csr_val, csr_row_ptr, csr_col_ind, temp_buffer)
end

function rocsparse_create_identity_permutation(handle, n, p)
    ccall((:rocsparse_create_identity_permutation, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, Ptr{rocsparse_int}), handle, n, p)
end

function rocsparse_csrsort_buffer_size(handle, m, n, nnz, csr_row_ptr, csr_col_ind, buffer_size)
    ccall((:rocsparse_csrsort_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Csize_t}), handle, m, n, nnz, csr_row_ptr, csr_col_ind, buffer_size)
end

function rocsparse_csrsort(handle, m, n, nnz, descr, csr_row_ptr, csr_col_ind, perm, temp_buffer)
    ccall((:rocsparse_csrsort, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, nnz, descr, csr_row_ptr, csr_col_ind, perm, temp_buffer)
end

function rocsparse_cscsort_buffer_size(handle, m, n, nnz, csc_col_ptr, csc_row_ind, buffer_size)
    ccall((:rocsparse_cscsort_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Csize_t}), handle, m, n, nnz, csc_col_ptr, csc_row_ind, buffer_size)
end

function rocsparse_cscsort(handle, m, n, nnz, descr, csc_col_ptr, csc_row_ind, perm, temp_buffer)
    ccall((:rocsparse_cscsort, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, nnz, descr, csc_col_ptr, csc_row_ind, perm, temp_buffer)
end

function rocsparse_coosort_buffer_size(handle, m, n, nnz, coo_row_ind, coo_col_ind, buffer_size)
    ccall((:rocsparse_coosort_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Csize_t}), handle, m, n, nnz, coo_row_ind, coo_col_ind, buffer_size)
end

function rocsparse_coosort_by_row(handle, m, n, nnz, coo_row_ind, coo_col_ind, perm, temp_buffer)
    ccall((:rocsparse_coosort_by_row, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, nnz, coo_row_ind, coo_col_ind, perm, temp_buffer)
end

function rocsparse_coosort_by_column(handle, m, n, nnz, coo_row_ind, coo_col_ind, perm, temp_buffer)
    ccall((:rocsparse_coosort_by_column, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, Ptr{Cvoid}), handle, m, n, nnz, coo_row_ind, coo_col_ind, perm, temp_buffer)
end
...
function rocsparse_sbsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_sbsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_descr, Ptr{Cfloat}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_dbsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_dbsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_cbsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_cbsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_zbsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_zbsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_dgebsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_dgebsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_zgebsr2csr(handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
    ccall((:rocsparse_zgebsr2csr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}), handle, dir, mb, nb, bsr_descr, bsr_val, bsr_row_ptr, bsr_col_ind, row_block_dim, col_block_dim, csr_descr, csr_val, csr_row_ptr, csr_col_ind)
end
...
function rocsparse_dgebsr2gebsr_buffer_size(handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
    ccall((:rocsparse_dgebsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{Cdouble}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
end
...
function rocsparse_cgebsr2gebsr_buffer_size(handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
    ccall((:rocsparse_cgebsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
end
...
function rocsparse_zgebsr2gebsr_buffer_size(handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
    ccall((:rocsparse_zgebsr2gebsr_buffer_size, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_int, Ptr{Csize_t}), handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, row_block_dim_C, col_block_dim_C, buffer_size)
end
...
function rocsparse_cgebsr2gebsr(handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, descr_C, bsr_val_C, bsr_row_ptr_C, bsr_col_ind_C, row_block_dim_C, col_block_dim_C, temp_buffer)
    ccall((:rocsparse_cgebsr2gebsr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_float_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Cvoid}), handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, descr_C, bsr_val_C, bsr_row_ptr_C, bsr_col_ind_C, row_block_dim_C, col_block_dim_C, temp_buffer)
end
...
function rocsparse_zgebsr2gebsr(handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, descr_C, bsr_val_C, bsr_row_ptr_C, bsr_col_ind_C, row_block_dim_C, col_block_dim_C, temp_buffer)
    ccall((:rocsparse_zgebsr2gebsr, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_direction, rocsparse_int, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, rocsparse_mat_descr, Ptr{rocsparse_double_complex}, Ptr{rocsparse_int}, Ptr{rocsparse_int}, rocsparse_int, rocsparse_int, Ptr{Cvoid}), handle, dir, mb, nb, nnzb, descr_A, bsr_val_A, bsr_row_ptr_A, bsr_col_ind_A, row_block_dim_A, col_block_dim_A, descr_C, bsr_val_C, bsr_row_ptr_C, bsr_col_ind_C, row_block_dim_C, col_block_dim_C, temp_buffer)
end

function rocsparse_axpby(handle, alpha, x, beta, y)
    ccall((:rocsparse_axpby, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{Cvoid}, rocsparse_spvec_descr, Ptr{Cvoid}, rocsparse_dnvec_descr), handle, alpha, x, beta, y)
end

function rocsparse_gather(handle, y, x)
    ccall((:rocsparse_gather, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_dnvec_descr, rocsparse_spvec_descr), handle, y, x)
end

function rocsparse_scatter(handle, x, y)
    ccall((:rocsparse_scatter, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_spvec_descr, rocsparse_dnvec_descr), handle, x, y)
end

function rocsparse_rot(handle, c, s, x, y)
    ccall((:rocsparse_rot, librocsparse), rocsparse_status, (rocsparse_handle, Ptr{Cvoid}, Ptr{Cvoid}, rocsparse_spvec_descr, rocsparse_dnvec_descr), handle, c, s, x, y)
end

function rocsparse_sparse_to_dense(handle, mat_A, mat_B, alg, buffer_size, temp_buffer)
    ccall((:rocsparse_sparse_to_dense, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_spmat_descr, rocsparse_dnmat_descr, rocsparse_sparse_to_dense_alg, Ptr{Csize_t}, Ptr{Cvoid}), handle, mat_A, mat_B, alg, buffer_size, temp_buffer)
end

function rocsparse_dense_to_sparse(handle, mat_A, mat_B, alg, buffer_size, temp_buffer)
    ccall((:rocsparse_dense_to_sparse, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_dnmat_descr, rocsparse_spmat_descr, rocsparse_dense_to_sparse_alg, Ptr{Csize_t}, Ptr{Cvoid}), handle, mat_A, mat_B, alg, buffer_size, temp_buffer)
end

function rocsparse_spvv(handle, trans, x, y, result, compute_type, buffer_size, temp_buffer)
    ccall((:rocsparse_spvv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_spvec_descr, rocsparse_dnvec_descr, Ptr{Cvoid}, rocsparse_datatype, Ptr{Csize_t}, Ptr{Cvoid}), handle, trans, x, y, result, compute_type, buffer_size, temp_buffer)
end

function rocsparse_spmv(handle, trans, alpha, mat, x, beta, y, compute_type, alg, buffer_size, temp_buffer)
    ccall((:rocsparse_spmv, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, Ptr{Cvoid}, rocsparse_spmat_descr, rocsparse_dnvec_descr, Ptr{Cvoid}, rocsparse_dnvec_descr, rocsparse_datatype, rocsparse_spmv_alg, Ptr{Csize_t}, Ptr{Cvoid}), handle, trans, alpha, mat, x, beta, y, compute_type, alg, buffer_size, temp_buffer)
end

function rocsparse_spgemm(handle, trans_A, trans_B, alpha, A, B, beta, D, C, compute_type, alg, stage, buffer_size, temp_buffer)
    ccall((:rocsparse_spgemm, librocsparse), rocsparse_status, (rocsparse_handle, rocsparse_operation, rocsparse_operation, Ptr{Cvoid}, rocsparse_spmat_descr, rocsparse_spmat_descr, Ptr{Cvoid}, rocsparse_spmat_descr, rocsparse_spmat_descr, rocsparse_datatype, rocsparse_spgemm_alg, rocsparse_spgemm_stage, Ptr{Csize_t}, Ptr{Cvoid}), handle, trans_A, trans_B, alpha, A, B, beta, D, C, compute_type, alg, stage, buffer_size, temp_buffer)
end
...
const ROCSPARSE_VERSION_MAJOR = 1

const ROCSPARSE_VERSION_MINOR = 19

const ROCSPARSE_VERSION_PATCH = 4
