...
"""
@device_function wavefrontsize()::Cuint = ccall("llvm.amdgcn.wavefrontsize", llvmcall, Cuint, ())
...
```
"""
@device_function activelane()::Cuint = ccall("extern __ockl_activelane_u32", llvmcall, Cuint, ())
...
```
"""
@device_function function ballot(predicate::Bool)::UInt64
    if wavefrontsize() == 32
...
```
"""
@device_function bpermute(addr::Cint, val::Cint)::Cint = ccall(
...
```
"""
@device_function permute(addr::Integer, val::Cint)::Cint = ccall(
...
@device_function readfirstlane(val::Cint)::Cint = ccall(
